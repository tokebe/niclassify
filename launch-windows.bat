...
:errorNoPython
wscript "%~dp0\scripts\message.vbs" "Python is not installed. Please install Python >= 3.8 and then click 'ok'."
...
:errorWrongPython
wscript "%~dp0\scripts\message.vbs" "The wrong version of Python is installed. Please ensure you have a version of Python >= 3.8 and try again."
echo The wrong version of Python is installed. Please ensure you have a version of Python >= 3.8. https://www.python.org/downloads/
