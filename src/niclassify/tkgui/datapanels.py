...
class RetrievalPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent, app, *args, **kwargs):
        ...
        self.search_sec = ttk.LabelFrame(self, text="BOLD Lookup", labelanchor=tk.N)
        self.search_sec.pack(expand=True, fill=tk.X, side=tk.LEFT)

        self.taxon_label = tk.Label(self.search_sec, text="Taxonomy")
        self.taxon_label.pack(anchor=tk.W)

        self.taxon_input = tk.Entry(self.search_sec)
        self.taxon_input.pack(fill=tk.X)

        self.geo_label = tk.Label(self.search_sec, text="Geography")
        self.geo_label.pack(anchor=tk.W)

        self.geo_input = tk.Entry(self.search_sec)
        ...
        self.util_button_sec = tk.Frame(self.search_sec)
        ...
        self.load_sec = ttk.LabelFrame(self, text="Custom Data", labelanchor=tk.N)
        self.load_sec.pack(expand=True, fill=tk.BOTH, side=tk.RIGHT)

        self.load_button = tk.Button(
            self.load_sec, text="Load Custom Data", command=self.app.load_sequence_data
        )
...
class PreparationPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent, app, *args, **kwargs):
        ...
        self.filter_size_label = tk.Label(self, text="Fragment Length (bp)")
        ...
        self.taxon_split_label = tk.Label(self, text="Taxonomic Split Level:")
        self.taxon_split_label.pack(anchor=tk.W)

        self.taxon_split_selector = ttk.Combobox(self, height=10, state="readonly")
        ...
        self.taxon_split_selector.bind("<<ComboboxSelected>>", self.app.set_taxon_level)
        ...
        self.method_select_label = tk.Label(self, text="Species Delimitation Method:")
        ...
        self.reference_geo_label = tk.Label(self, text="Reference Geography:")
