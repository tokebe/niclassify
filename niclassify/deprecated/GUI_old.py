...
class MainApp(tk.Frame):
    ...
    def get_data_file(self):
        ...
        # otherwise it's some sort of text file
        else:
    ...
    def get_split_data(self):
        ...
        # scale data
        self.data_norm = utilities.scale_data(self.data)
    ...
    def make_predictions(self):
        ...
        self.data_imp = utilities.impute_data(self.data_norm)
        # make predictions
    ...
    def train_classifier(self):
        ...
        self.data_known, self.metadata_known = core.get_known(
            self.data_norm, self.metadata, class_column)

        # train classifier
        logging.info("training random forest...")
        self.classifier = core.train_forest(
            self.data_known,
            self.metadata_known,
            class_column,
